<p>Welcome to CS 61AS, Structure and Interpretation of Computer Programs (SICP)!</p>

<p>Since this course is relatively new, there will be occasional updates to the following information so as to optimize your experience as students.</p>

<h2>Discussions and Labs</h2>
<p>Lab is held every Monday through Thursday in 330 Soda. Discussions will be held on Mondays and Thursdays. The discussion schedule that your unit track follows is linked in the Calendar on the homepage. <strong>In order to receive attendance points during times when your discussion is being held, you must either be in lab or at your discussion.</strong>
<p>Discussions will be one hour long, which is a third of a lab section. If, during your discussion time, you are neither at discussion or in lab, you will NOT get attendance points.</p>
<p>You are free to attend discussions of different unit track than yours if you wish.</p>
<p></p>

<h2>Attendance</h2>
<p>You are expected to attend every class meeting. Attendance will be graded. <strong>You will receive&nbsp;0.5&nbsp;points for every hour&nbsp;of lab you attend.</strong> (e.g., 2 hr of lab on Monday = 1 hr of lab on Monday and 1 hr of lab on Friday = 1 hr of lab and 1 hr of discussion on Wednesday = 1 attendance point.) You must be working on 61AS material during this time, and there should be a TA or lab assistant present at all times. You will also get points for attending discussions.&nbsp;</p>
...
<p>For example, if Louis Reasoner is taking units 1-3, then [number of lessons] = 10, so [maxpoints] = 2 * 10 = 20, i.e. Louis can get at most 20 attendance points.</p>
<p>Assuming Louis doesn't finish early, he would have to attend at least 2*20 = 40 hours of lab to get full credit.</p>
...
<p>Each lesson begins with links to the reading for that lesson. Do the reading before you do the lesson! In addition to the textbook, you should read Brian's lecture notes, also online. A good learning&nbsp;method for a lesson is to read&nbsp;the lecture notes, then go through the lesson, then read SICP. SICP is an awesome book, but it can be a little dense. Each lesson in units 1-4 also includes videos from a previous semester of the lecture-based 61A. These are completely optional and you should NOT watch them in class, but feel free to watch them in your own time for extra practice.</p>
<p>Homework will be graded based on effort rather than correctness. This being said, <b>any homework or project that does not load into the interpreter will receive NO credit.</b>&nbsp;This is to make sure that you always test your code by loading the file into your interpreter.</p>
...
<h2>Quizzes</h2>
<p>After completing each lesson and reading the online solutions, you will take an online quiz on the material you learned in that lesson.&nbsp;The link to the quiz system is in the navigation bar at the top of this page, and also on the Resources page, under Course Material Resources. Or, you can click <a href="http://www.cs61as-quizzes.com/" target="_blank">here</a>. <strong>**NOTE: Quizzes for lesson 4, 8, and 9 are still paper quizzes. Ask the TA to take those quizzes.**</strong></p>
...
<p>Each quiz is worth 10 points, and will be graded and returned to you by the next lab section. <strong>You have one retake per quiz, where the retake will consist of entirely different questions. Your grade for the retake will be capped at 9 points. We will use your retake grade even if you scored higher in the first one</strong>. If you don't pass a quiz the second time, email your TA so they can help you get back on track. The quizzes are closed book, and you are allowed<strong>&nbsp;one double-sided cheat sheet for each quiz.</strong></p>
...
<p>Each lesson in this course has exercises labelled "Lab Activity" and other exercises labelled "Homework." The lab exercises are not turned in for credit. You should try each exercise on your own first, but you are encouraged to work in groups. (But bear in mind that in a self-paced course the student next to you may be working on something different from you.) Lab exercises are an introduction to the lesson's ideas, and the goal is for you to understand what they're asking by the end of the lab activity.</p>
<p>Homework assignments are expected to be completed individually. If two homework assignments are too similar, we will assume academic dishonesty and neither student will receive any credit for the assignment. You are welcome to discuss the homework with other students, but the solution you turn in must be entirely your own. <strong>To clarify, you may look over other students' lab code, but not homework. You may only share project code with your partner, for partner projects.</strong></p>
...
<p><strong>Any act of cheating in the course will receive the harshest punishment possible.</strong> The first offense results in <strong>at minimum</strong> a negative score for the assignment. If you are found to be cheating a second time, we will not hesitate to fail you, report you to the center for student conduct, and, you guessed it, call your parents.</p>
<p>We run all submitted assignments through a software plagiarism system that detects similar submissions. This will catch both copying from an online source and copying from peers. The system is <em>very good</em> at what it does. Do not assume you can outsmart it.</p>
<h2>Final Thoughts</h2>
<p>To end on a happier note, here are a few final pieces of advice: this course attempts to teach a lot of the big ideas in computer science. If you ever feel like you're drowning in the material, do not hesitate to talk to a TA! 61AS is a great introductory course that will ease you into all the amazing concepts that future CS courses will cover, so remember to keep an open mind, have fun, and always respect the data abstraction!</p>